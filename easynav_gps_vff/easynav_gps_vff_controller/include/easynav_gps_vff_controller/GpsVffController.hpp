...
/// \file
/// \brief Declaration of the GpsVffController method.

#ifndef EASYNAV_CONTROLLER__GPSVFFCONTROLLER_HPP_
#define EASYNAV_CONTROLLER__GPSVFFCONTROLLER_HPP_
...
/**
 * @class GpsVffController
 * @brief A default "GpsVff" implementation for the Control Method.
 *
 ...
 */
class GpsVffController : public easynav::ControllerMethodBase
{
public:
  /**
   * @brief Default constructor.
   */
  GpsVffController() = default;
...
private:
  ...
  /**
   * @brief Current yaw angle of the robot.
   */
  double yaw_;
...
#endif  // EASYNAV_CONTROLLER__GPSVFFCONTROLLER_HPP_
