...
/// \file
/// \brief Declaration of the GpsVffLocalizer class, a default plugin implementation for localization.

#ifndef EASYNAV_LOCALIZER__GPSVFFLOCALIZER_HPP_
#define EASYNAV_LOCALIZER__GPSVFFLOCALIZER_HPP_
 ...
 */
class GpsVffLocalizer : public easynav::LocalizerMethodBase
{
public:
  /**
   * @brief Default constructor.
   */
  GpsVffLocalizer() = default;
...
#endif  // EASYNAV_LOCALIZER__GPSVFFLOCALIZER_HPP_
